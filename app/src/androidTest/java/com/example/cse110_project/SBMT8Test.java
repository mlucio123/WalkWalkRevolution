...
public class SBMT8Test {

    private static final String TAG = "SBMT8";
    ...
    public void temp() {
                        ...
                        childAtPosition(
                                allOf(withId(R.id.invitationLayout),
                                        childAtPosition(
                                                ...
                                                1)),
                                2)));
        appCompatEditText10.perform(scrollTo(), replaceText("zx"), closeSoftKeyboard());
                        ...
                        childAtPosition(
                                allOf(withId(R.id.invitationLayout),
                                        childAtPosition(
                                                ...
                                                1)),
                                4)));
        appCompatEditText12.perform(scrollTo(), replaceText("wtf@gmail.com"), closeSoftKeyboard());
        ...
        Log.d(TAG, "After 2nd to last sleep");
